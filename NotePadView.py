...
class Notepad:
    ...
    def set_tool_bar(self):
        ...
        ## datetime
        self.show_time = tk.Label(self.tool_bar)
        self.show_time.grid(row=0, column=20, padx=400, sticky='E')
    ...
    def set_tool_bar_event_bindings(self):
        ...
        self.show_time.configure(text=self.showdatetime())
    ...
    def say_something(self):
        ...
        except UnknownValueError as unknown:
            messagebox.showerror("Speech Unrecognizable!", "Could not recognize the command")
    ...
    # _____________________________________________secure files___________________________________ #
    ...
    def remove_secure_file(self):
        try:
            ...
            if len(self.sel_file_index_tuple) != 0:
                ...
                messagebox.showerror("Success!", "File removed successfully")
            else:
                messagebox.showerror("Error!", "Please select a file first")
        except:
    ...
    def showdatetime(self):
        ...
        time = strftime('%H:%M:%S %p')+'\n'+f"{e.day}/{e.month}/{e.year}"
        self.show_time.config(text=time)
        self.show_time.after(1000, self.showdatetime)
    ...
    def show_timer(self):
        ...
        display = string
        self.timer['text'] = display
        self.timer.after(1000, self.show_timer)
        counter += 1


if __name__ == '__main__':
    obj = Notepad()
    t1 = Thread(target=obj.show_timer)
    t1.start()
    obj.run()
